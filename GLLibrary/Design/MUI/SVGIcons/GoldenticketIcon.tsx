...
export default function GoldenticketIcon(props: any) {
    ...
    <SvgIcon {...props}>
      ...
      <defs>
        ...
        >
          ...
          <stop stopColor={lighten(color1, 0.25)} offset="100%"></stop>
        </linearGradient>
      </defs>
      <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="GoldenTicket">
          <rect fill="none" x="0" y="0" width="24" height="24"></rect>
          <g transform="translate(1, 4)" fill={color1} fillRule="nonzero">
